export default {
  ...
  common: {
    ...
    no: 'Не',
    news: 'Новина',
    poweredByOboApp: 'от OboApp',
    timespanActive: 'Активно',
    timespanUpcoming: 'Предстоящо',
    timespanEnded: 'Приключило',
    cityWide: 'За целия град',
    responsibleEntity: 'Отговорна организация',
    addresses: 'Адреси',
