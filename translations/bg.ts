export default {
  ...
  profile: {
    ...
    anonymity:
      'Основната функционалност на приложението работи без нужда от регистрация. За да използвате персонализирани функции ще трябва да се регистрирате.',
  ...
  wasteContainers: {
    ...
    address: 'Адрес',
    serviceInterval: 'Интервал на обслужване',
  ...
  bulkPhotoUpload: {
    ...
    instructions:
      'Изберете снимки за актуализиране на статуса на градски обекти. Избраните снимки ще бъдат обработени и тези, които съдържат координати и времеви печат, ще бъдат прикачени към сигнала.',
