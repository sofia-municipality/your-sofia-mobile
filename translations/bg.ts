export default {
  ...
  profile: {
    ...
    anonymity:
      'Основната функционалност на приложението работи без нужда от регистрация. За да подавате сигнали и да използвате персонализирани функции ще трябва да се регистрирате.',
