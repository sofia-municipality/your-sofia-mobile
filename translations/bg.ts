export default {
  ...
  profile: {
    ...
    anonymity: 'Основната функционалност на приложението работи без нужда от регистрация. За допълнителни функции може да се наложи да се регистрирате.',
  ...
  signals: {
    ...
    duplicateMessage: 'Вече сте докладвали проблем за този контейнер (Сигнал #{{id}}). Можете да прегледате или редактирате съществуващия сигнал.',
