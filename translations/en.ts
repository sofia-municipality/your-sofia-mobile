export default {
  ...
  fountains: {
    ...
    loadError: 'Failed to load fountains',
  ...
  signals: {
    ...
    resolveConfirmTitle: 'Resolve signal',
    resolveConfirmMessage: 'Mark this signal as resolved? The reporter will be notified.',
    resolveSuccess: 'Signal marked as resolved',
    ...
    filteredForContainer: 'Showing signals for object #{{id}}',
    ...
    categories: {
      'drinking-fountain': 'Drinking Fountain Issue',
  ...
  newCityObject: {
    ...
    fountainIsActive: 'Is the fountain working?',
    notes: 'Notes',
  ...
  missions: {
    ...
    questBoardSubtitle: 'Take on a mission and help your neighborhood',
    myMissions: 'My Missions',
    verifyMissions: 'Verify Missions',
    missionDetails: 'Mission Details',
    darPoints_one: '{{count}} dar',
    darPoints_other: '{{count}} dars',
    levels: {
      goodFirstMission: 'Good First Mission',
    ...
    status: {
      ...
      returnedForImprovement: 'Needs Improvement',
      completed: 'Completed',
      cancelled: 'Cancelled',
    },
    claim: 'Claim Mission',
    submitForReview: 'Submit for Review',
    submittedForReview: 'Mission submitted for inspector review',
    instructions: 'Instructions',
    tasks: 'Tasks',
    acceptanceCriteria: 'Acceptance Criteria',
    photoBefore: 'Before',
    photoAfter: 'After',
    overallPhotos: 'Overall Site Photos',
    reviewNotes: 'Inspector Notes',
    noMissionsAvailable: 'No missions available right now',
    noMissionsToVerify: 'No missions waiting for verification',
    loginRequiredTitle: 'Log In',
    loginRequiredBody: 'You need to log in to see and claim missions.',
    notFound: 'Mission not found',
    claimError: 'Failed to claim mission',
    taskPhotoError: 'Failed to upload task photo',
    overallPhotoError: 'Failed to upload photo',
    submitReviewError: 'Failed to submit for review',
    verifyError: 'Failed to verify mission',
    approve: 'Approve',
    reject: 'Reject',
    cameraPermissionRequired: 'Please allow camera access to take a photo',
    galleryPermissionRequired: 'Please allow photo library access to pick an image',
    selectPhotoSource: 'Choose photo source',
    photoSourceCamera: 'Camera',
    photoSourceGallery: 'Gallery',
    form: {
      createMission: 'Create Mission',
      createMissionTitle: 'Create Mission',
      createMissionSubtitle: 'Create a mission linked to this signal',
      title: 'Mission Title',
      titlePlaceholder: 'Enter mission title',
      titleRequired: 'Please enter mission title',
      description: 'Description',
      descriptionPlaceholder: 'Optional short description',
      level: 'Level',
      status: 'Status',
      pointsReward: 'Points Reward',
      pointsRewardPlaceholder: 'e.g. 10',
      pointsRewardMin: 'Points reward cannot be negative',
      generalInstructions: 'General Instructions',
      generalInstructionsPlaceholder: 'Explain what the citizen should do',
      generalInstructionsRequired: 'General instructions are required',
      tasks: 'Tasks',
      task: 'Task',
      tasksRequired: 'At least one task is required',
      taskTitlePlaceholder: 'Task title',
      taskTitleRequired: 'Task title is required',
      taskInstructionsPlaceholder: 'Step-by-step instructions',
      taskInstructionsRequired: 'Task instructions are required',
      taskAcceptanceCriteriaPlaceholder: 'How inspector will verify the task',
      taskAcceptanceCriteriaRequired: 'Acceptance criteria are required',
      requiresBeforePhoto: 'Requires before photo',
      requiresAfterPhoto: 'Requires after photo',
      atLeastOnePhotoRequired: 'At least one photo requirement should stay enabled',
      addTask: 'Add Task',
